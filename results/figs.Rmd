...
### By sample
```{r}
p <- plot_feature(sobj, "sample", pt_alpha = 0.75, embedding = "umap")
p
save_plot(file.path(fig_dir,"umap_by_sample.pdf"), p, base_asp = 1.75)
```
...
```{r}
p <- plot_umap(sobj, "clusters", pt_alpha = 0.75)
p
