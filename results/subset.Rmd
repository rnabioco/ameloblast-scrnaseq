...
regenerate marker lists using updated ids, should be identical just with new group names. 

```{r}
library(presto)
cell_type_markers <- wilcoxauc(sobj, "pub_cell_types")
...
write_tsv(cell_type_markers,
          file.path(mkrs_dir, "ablast_subset_pub_cell_type_markers.tsv"))
```
